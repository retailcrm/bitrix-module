...
(function() {
    ...
    BX.Sale.OrderAjaxComponent.initializePrimaryFields = function() {
    ...
    BX.Sale.OrderAjaxComponent = {
        ...
        init: function(parameters) {
            ...
            this.loyaltyDiscount       = parameters.loyaltyDiscount;
            this.bitrixDiscount        = parameters.bitrixDiscount;
            this.calculateItemsInput   = parameters.calculateItemsInput;
    ...
    BX.Sale.OrderAjaxComponent.editPaySystemItems = function(paySystemNode)
    {
        ...
        let paySystemItemsContainer = BX.create('DIV', {props: {className: 'col-sm-7 bx-soa-pp-item-container'}}),
            paySystemItemNode, i;
