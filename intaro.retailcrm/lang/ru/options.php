...
$MESS ['FIX_UPLOAD_CUSTOMER_INFO'] = 'После нажатия на кнопку, будет создан агент на запуск скрипта. В зависимости от количества клиентов в базе, будет расти время выполнения скрипта. Желательно запускать скрипт ночью. Скрипт возможно запустить только 1 раз.';
