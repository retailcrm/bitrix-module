...
$MESS ['INTEGRATION_PAYMENT_LABEL'] = 'При сопоставлении интеграционных оплат CRM, на стороне системы создаётся обычная оплата, к которой будут привязываться заказы. <br> Если у вас в CRM есть интеграционные доставки, то разрешить новый способ оплаты нужно вручную непосредственно в настройках интеграций';
