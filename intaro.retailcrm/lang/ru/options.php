...
$MESS ['ABANDONED_CART'] = 'Передавать состав корзины в систему';
$MESS['ABANDONED_CART_LABEL'] = "При включенной опции, данные о составе корзины передаются в карточку клиента в системе";
